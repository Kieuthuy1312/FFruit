<!DOCTYPE html>
<!-- saved from url=(0041)https://adminlte.io/themes/v3/index2.html -->
<html lang="en" style="height: auto;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <!-- overlayScrollbars -->
  <link rel="stylesheet" href="admin/OverlayScrollbars.min.css">
  <!-- Theme style -->
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center" style="height: 0px;">
    <img class="animation__wobble" src="./AdminLTE 3 _ Dashboard 2_files/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60" style="display: none;">
  </div>
  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" data-widget="pushmenu" href="https://adminlte.io/themes/v3/index2.html#" role="button"><i class="fas fa-bars"></i></a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="https://adminlte.io/themes/v3/index3.html" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="https://adminlte.io/themes/v3/index2.html#" class="nav-link">Contact</a>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      <!-- Navbar Search -->
      <li class="nav-item">
        <a class="nav-link" data-widget="navbar-search" href="https://adminlte.io/themes/v3/index2.html#" role="button">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="https://adminlte.io/themes/v3/index2.html#">
          <i class="far fa-comments"></i>
          <span class="badge badge-danger navbar-badge">3</span>
        </a>
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="https://adminlte.io/themes/v3/index2.html#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="./AdminLTE 3 _ Dashboard 2_files/user1-128x128.jpg" alt="User Avatar" class="img-size-50 mr-3 img-circle">
          ...
          <a href="https://adminlte.io/themes/v3/index2.html#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="./AdminLTE 3 _ Dashboard 2_files/user8-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  John Pierce
          ...
          <a href="https://adminlte.io/themes/v3/index2.html#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="./AdminLTE 3 _ Dashboard 2_files/user3-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  Nora Silvester
          ...
          <div class="dropdown-divider"></div>
          <a href="https://adminlte.io/themes/v3/index2.html#" class="dropdown-item dropdown-footer">See All Messages</a>
        </div>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <div class="dropdown-divider"></div>
          <a href="https://adminlte.io/themes/v3/index2.html#" class="dropdown-item dropdown-footer">See All Notifications</a>
        </div>
      </li>
      <li class="nav-item">
        <a class="nav-link" data-widget="fullscreen" href="https://adminlte.io/themes/v3/index2.html#" role="button">
          <i class="fas fa-expand-arrows-alt"></i>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" data-widget="control-sidebar" data-slide="true" href="https://adminlte.io/themes/v3/index2.html#" role="button">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar os-host os-theme-light os-host-overflow os-host-overflow-y os-host-resize-disabled os-host-scrollbar-horizontal-hidden os-host-transition"><div class="os-resize-observer-host observed"><div class="os-resize-observer" style="left: 0px; right: auto;"></div></div><div class="os-size-auto-observer observed" style="height: calc(100% + 1px); float: left;"><div class="os-resize-observer"></div></div><div class="os-content-glue" style="margin: 0px -8px; width: 249px; height: 453px;"></div><div class="os-padding"><div class="os-viewport os-viewport-native-scrollbars-invisible" style="overflow-y: scroll;"><div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="https://adminlte.io/themes/v3/index2.html#" class="d-block">Alexander Pierce</a>
        </div>
      </div>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="https://adminlte.io/themes/v3/index2.html#">Home</a></li>
                ...
                <div class="card-tools">
                  ...
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" role="menu">
                      <a href="https://adminlte.io/themes/v3/index2.html#" class="dropdown-item">Action</a>
                      <a href="https://adminlte.io/themes/v3/index2.html#" class="dropdown-item">Another action</a>
                      <a href="https://adminlte.io/themes/v3/index2.html#" class="dropdown-item">Something else here</a>
                      <a class="dropdown-divider"></a>
                      <a href="https://adminlte.io/themes/v3/index2.html#" class="dropdown-item">Separated link</a>
                    </div>
                  </div>
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="card direct-chat direct-chat-warning">
                  ...
                  <div class="card-body">
                    ...
                    <div class="direct-chat-messages">
                      ...
                      <div class="direct-chat-msg">
                        ...
                        <!-- /.direct-chat-infos -->
                        <img class="direct-chat-img" src="./AdminLTE 3 _ Dashboard 2_files/user1-128x128.jpg" alt="message user image">
                        <!-- /.direct-chat-img -->
                      ...
                      <div class="direct-chat-msg right">
                        ...
                        <!-- /.direct-chat-infos -->
                        <img class="direct-chat-img" src="./AdminLTE 3 _ Dashboard 2_files/user3-128x128.jpg" alt="message user image">
                        <!-- /.direct-chat-img -->
                        <div class="direct-chat-text">
                      ...
                      <ul class="contacts-list">
                        <li>
                          <a href="https://adminlte.io/themes/v3/index2.html#">
                            <img class="contacts-list-img" src="./AdminLTE 3 _ Dashboard 2_files/user1-128x128.jpg" alt="User Avatar">
                        ...
                        <li>
                          <a href="https://adminlte.io/themes/v3/index2.html#">
                            <img class="contacts-list-img" src="./AdminLTE 3 _ Dashboard 2_files/user7-128x128.jpg" alt="User Avatar">
                        ...
                        <li>
                          <a href="https://adminlte.io/themes/v3/index2.html#">
                            <img class="contacts-list-img" src="./AdminLTE 3 _ Dashboard 2_files/user3-128x128.jpg" alt="User Avatar">
                        ...
                        <li>
                          <a href="https://adminlte.io/themes/v3/index2.html#">
                            <img class="contacts-list-img" src="./AdminLTE 3 _ Dashboard 2_files/user5-128x128.jpg" alt="User Avatar">
                        ...
                        <li>
                          <a href="https://adminlte.io/themes/v3/index2.html#">
                            <img class="contacts-list-img" src="./AdminLTE 3 _ Dashboard 2_files/user6-128x128.jpg" alt="User Avatar">
                        ...
                        <li>
                          <a href="https://adminlte.io/themes/v3/index2.html#">
                            <img class="contacts-list-img" src="./AdminLTE 3 _ Dashboard 2_files/user8-128x128.jpg" alt="User Avatar">
                  ...
                  <!-- /.card-body -->
                  <div class="card-footer">
                    <form action="https://adminlte.io/themes/v3/index2.html#" method="post">
                ...
                <div class="card">
                  ...
                  <div class="card-body p-0">
                    <ul class="users-list clearfix">
                      <li>
                        <img src="./AdminLTE 3 _ Dashboard 2_files/user1-128x128.jpg" alt="User Image">
                        <a class="users-list-name" href="https://adminlte.io/themes/v3/index2.html#">Alexander Pierce</a>
                        <span class="users-list-date">Today</span>
                      </li>
                      <li>
                        <img src="./AdminLTE 3 _ Dashboard 2_files/user8-128x128.jpg" alt="User Image">
                        <a class="users-list-name" href="https://adminlte.io/themes/v3/index2.html#">Norman</a>
                        <span class="users-list-date">Yesterday</span>
                      </li>
                      <li>
                        <img src="./AdminLTE 3 _ Dashboard 2_files/user7-128x128.jpg" alt="User Image">
                        <a class="users-list-name" href="https://adminlte.io/themes/v3/index2.html#">Jane</a>
                        <span class="users-list-date">12 Jan</span>
                      </li>
                      <li>
                        <img src="./AdminLTE 3 _ Dashboard 2_files/user6-128x128.jpg" alt="User Image">
                        <a class="users-list-name" href="https://adminlte.io/themes/v3/index2.html#">John</a>
                        <span class="users-list-date">12 Jan</span>
                      </li>
                      <li>
                        <img src="./AdminLTE 3 _ Dashboard 2_files/user2-160x160.jpg" alt="User Image">
                        <a class="users-list-name" href="https://adminlte.io/themes/v3/index2.html#">Alexander</a>
                        <span class="users-list-date">13 Jan</span>
                      </li>
                      <li>
                        <img src="./AdminLTE 3 _ Dashboard 2_files/user5-128x128.jpg" alt="User Image">
                        <a class="users-list-name" href="https://adminlte.io/themes/v3/index2.html#">Sarah</a>
                        <span class="users-list-date">14 Jan</span>
                      </li>
                      <li>
                        <img src="./AdminLTE 3 _ Dashboard 2_files/user4-128x128.jpg" alt="User Image">
                        <a class="users-list-name" href="https://adminlte.io/themes/v3/index2.html#">Nora</a>
                        <span class="users-list-date">15 Jan</span>
                      </li>
                      <li>
                        <img src="./AdminLTE 3 _ Dashboard 2_files/user3-128x128.jpg" alt="User Image">
                        <a class="users-list-name" href="https://adminlte.io/themes/v3/index2.html#">Nadia</a>
                        <span class="users-list-date">15 Jan</span>
                      </li>
                    </ul>
                    <!-- /.users-list -->
              ...
              <div class="card-body p-0">
                <div class="table-responsive">
                  <table class="table m-0">
                    ...
                    <tbody>
                    <tr>
                      <td><a href="https://adminlte.io/themes/v3/pages/examples/invoice.html">OR9842</a></td>
                    ...
                    <tr>
                      <td><a href="https://adminlte.io/themes/v3/pages/examples/invoice.html">OR1848</a></td>
                    ...
                    <tr>
                      <td><a href="https://adminlte.io/themes/v3/pages/examples/invoice.html">OR7429</a></td>
                      <td>iPhone 6 Plus</td>
                ...
                <ul class="products-list product-list-in-card pl-2 pr-2">
                  <li class="item">
                    <div class="product-img">
                      <img src="./AdminLTE 3 _ Dashboard 2_files/default-150x150.png" alt="Product Image" class="img-size-50">
                    </div>
...
<!-- overlayScrollbars -->
<script src="admin/jquery.overlayScrollbars.min.js"></script>
<!-- AdminLTE App -->
<script src="admin/adminlte.js"></script>

<!-- PAGE PLUGINS -->
<!-- jQuery Mapael -->
<script src="admin/jquery.mousewheel.js"></script>
<script src="admin/raphael.min.js"></script>
<script src="admin/jquery.mapael.min.js"></script>
<script src="admin/usa_states.min.js"></script>
<!-- ChartJS -->
<script src="admin/Chart.min.js"></script>

<!-- AdminLTE for demo purposes -->
<script src="admin/demo.js"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="admin/dashboard2.js"></script>
